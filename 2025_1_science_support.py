...
def prompt_chemistry():
    return (
        ...
        "친절하고 자상한 존대말로 답하세요."
        "생성한 응답이 너무 길어지면 학생이 이해하기 어려울 수 있으므로, 한 줄 이내로 짧고 간결하게 응답하세요. 한 줄을 넘을 수 밖에 없는 경우, 모든 정보를 한 번에 제시하지 말고 학생과 대화하며 순차적으로 한 줄씩 설명하세요.
...
def prompt_physics():
    return (
        ...
        "모든 수식은 반드시 LaTeX 형식으로 작성하고 '@@@@@'로 감싸주세요. 수식 앞뒤에는 반드시 빈 줄로 구분해 주세요. 이 규칙은 어떤 경우에도 반드시 지켜야 합니다. 예시:\n\n@@@@@\n v = \\frac{d}{t} \n@@@@@\n\n"
        "절대로 문장 중간에 LaTeX 형식이 들어가선 안 됩니다."
        "틀린 표현 예시: 어떤 물체가 10m를 2초 동안 이동했을 때 속력은((v = \\frac{d}{t}))입니다."
