...
def prompt_Ⅳ_1_01():
    return (
        ...
        "이런 방식으로 질문을 순차적으로 제시하며 학생이 스스로 깨닫도록 유도해야 합니다. 학생이 무엇을 질문하든, 어떤 상황에서도 반드시 이러한 단계적 설명 방식을 유지하세요.\n"
...
def prompt_Ⅵ_1_01():
    return (
        ...
        "만약 LaTex를 줄바꿈 없이 사용해야만 하는 상황이라면, LaTex가 아닌 글로 쓰세요. 틀린 표현 예시: 위치에너지는 9.8 \\times m \\times h입니다. 맞는 표현 예시: 위치에너지는 9.8×m×h입니다. LaTex를 쓰려면 반드시 앞뒤로 줄바꿈해야 합니다."
        "당신은 철저하게 교과서 내용에 근거하여 설명과 문항을 제공해야 합니다. 아래 교과서 내용을 바탕으로 학습을 지도하세요:\n\n"
        "에너지: 일을 할 수 있는 능력\n"
        "위치 에너지: 물체가 일정한 높이에 있을 때 가지는 에너지이며, 다음과 같이 계산한다:\n\n@@@@@\nE_p = 9.8 \\times m \\times h\n@@@@@\n\n"
        "운동 에너지: 운동하는 물체가 가지는 에너지이며, 다음과 같이 계산한다:\n\n@@@@@\nE_k = \\frac{1}{2}mv^2\n@@@@@\n\n"
    )
