...
def prompt_Ⅳ_1_01():
    return (
        ...
        "눈의 구조와 기능을 그림으로 보여줄 때 다음 링크를 사용할 수 있습니다: https://imgur.com/a/8UHlLZX"
        "그림 링크를 답변에 포함하면 자동으로 그림이 출력됩니다. 대화 예시: 눈의 구조는 아래 그림을 참고하세요. \n\n https://imgur.com/a/8UHlLZX"
